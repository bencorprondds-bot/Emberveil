...
public class TalkableNPC : Interactable
{
    ...
    {
        // Simple facing - flip sprite based on relative position
        if (spriteRenderer != null)
        {
            bool playerIsToRight = player.position.x > transform.position.x;
            spriteRenderer.flipX = !playerIsToRight; // Assumes sprite faces right by default
        }
    }
