...
/// <summary>
/// An object that Mouse can lift and move using her Gloves.
...
public class LiftableObject : Interactable
{
    ...
    void Update()
    {
        ...
        else if (currentLiftOffset > 0)
        {
            ...
            // Object stays where it was dropped, just settles vertically
        }
    }
    ...
    private void Drop()
    {
        ...
        // Snap to grid (optional - helps with puzzle placement)
        // SnapToGrid();
    }
